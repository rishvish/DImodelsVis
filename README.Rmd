...
We fit different models with different interaction structures as described in [Moral et al., 2023](<doi:10.1111/2041-210X.14158>). 
```{r}
...
We can visualise model selection by passing our models as a list to the `model_selection` function and visualising the best performing metric across different information criteria. Run `?model_selection` for more information on customising the plot.
...
Run `?model_diagnostics` for more information on customising the plot.
...
Run `?prediction_contributions` for more information on creating and customising the plot.
...
Run `?gradient_change` for more information on creating and customising the plot.
...
Run `?conditional_ternary` for more information on creating and customising the plot.
...
Run `?visualise_effects` for more information on creating and customising the plot.
...
Run `?simplex_path` for more information on creating and customising the plot.
