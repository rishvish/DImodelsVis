---
title: "DImodelsVis with regression models fit using the DImodelsMulti R package"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{DImodelsVis with regression models fit using the DImodelsMulti R package}
