...
![Package workflow](reference/figures/DImodelsVisWorkflowPackage.png)
...
across different information criteria. Run
...
function](reference/figures/README-model-selection-1.png)
...
function](reference/figures/README-model-diagnostics-1.png)
...
function](reference/figures/README-prediction-contributions-1.png)
...
function](reference/figures/README-gradient-change-1.png)

This shows that on average the predicted response increases as richness
increases but at a saturating rate. Run
...
function](reference/figures/README-cond-ternary-1.png)
...
function](reference/figures/README-effects-plot-1.png)
...
function](reference/figures/README-simplex-path-1.png)
...
monoculture of `p3` increases the response. Run
